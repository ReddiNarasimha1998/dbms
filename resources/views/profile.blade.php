    ...
    <div class="col-sm-4">
     ...
     <div class="col-sm-4">   
       <label for="department" style="color:#7ed321">DEPARTMENT:</label>    
        <input type="text" class="form-control" id="department" placeholder="Department" name="department"  value="{{$dep->deptname}}" style="width:50%;">
      </div>
    </div><br>
    <div class="form-group">
     <div class="col-sm-4">          
    ...
    <div class="form-group">
     <div class="row">
      <div class="col-sm-3" style="margin-left:100px;">
        <a href="{{route('editprofileuser')}}" style="text-decoration:none;">EDIT</a>
      </div>
     <div class="col-sm-3">
