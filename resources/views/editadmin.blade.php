...
<div class="container" style="background-color: #fff;float:left;">
  ...
  <form class="form-horizontal" action="/adminprofileuser/" method="post">
     {{csrf_field()}}
    ...
    <label for="mobile" style="color:#7ed321">MOBILE:</label>
        <input type="text" class="form-control" id="mobile" placeholder="Mobile" name="mobile" pattern="[1-9]{1}[0-9]{9}" value="{{$student->phone_number}}" style="width:50%;">
      </div>
    </div><br>
